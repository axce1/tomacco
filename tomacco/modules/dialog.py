...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.finish_edit = QtWidgets.QLineEdit(Dialog)
        ...
        self.cleanupLong = QtWidgets.QCheckBox(Dialog)
        ...
        #self.triggered.connect(self.start_run, pyqtSignal(_fromUtf8("toggled(bool)")), self.start_edit.setEnabled)
        self.start_run.clicked.connect(self.start_edit.setEnabled)
        #QtCore.QObject.connect(self.finish_run, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.finish_edit.setEnabled)
        #self.triggered.connect(self.finish_run, pyqtSignal(_fromUtf8("toggled(bool)")), self.finish_edit.setEnabled)
        self.finish_run.clicked.connect(self.finish_edit.setEnabled)
